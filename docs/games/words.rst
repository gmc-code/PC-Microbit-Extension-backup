...
| The list comprehension, ``charset = [i for i in range(65, 91)]``, makes a list of the ASCII code numbers for the upper case letters from 65 to 90.
| The list comprehension, ``chars = [chr(i) for i in charset]``, takes that lsit of numbers and use the chr function to get the correspondinh character for that ASCII number. 
            ...
            .. tab-set::
                ...
                .. tab-item:: Q1
                    ...
                    .. code-block:: python
                        ...
                        charset = [i for i in range(97, 123)]  # lower case letters
                        chars = [chr(i) for i in charset]
                        print(chars)
                ...
                .. tab-item:: Q2
                    ...
                    .. code-block:: python
                        ...
                        charset = [i for i in range(48, 58)]  # digits
                        chars = [chr(i) for i in charset]
                        print(chars)
                ...
                .. tab-item:: Q3
                    ...
                    .. code-block:: python
                        ...
                        charset = [i for i in range(32, 48)]  # punctuation and symbols
                        chars = [chr(i) for i in charset]
                        print(chars)
...
| ``GetString()`` calls ``GetLetter()`` to add letters to the word string as long as the B button hasn't been pressed, otherwise it returns the word string, **usertext**.
| GetLetter() starts at the letter M which is the 13th letter of the alphabet, at index 12 in **chars**.
| GetLetter() loops until the A button is pressed, and when it is, it returns the current letter.
...
.. code-block:: python
    ...
    while True:
        ...
        if button_a.is_pressed():
            display.clear()
            sleep(1000)
            # clear button a pressing so it can be checked for being pressed again in GetString
